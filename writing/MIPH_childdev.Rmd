...
As music has been shown to affect a variety of affect- and arousal-related variables in infants in the short-term [e.g., @Bainbridge2021; @Cirelli2020; @Corbeil2016], a key question for this randomized trial is whether such effects are cumulative. Does music enrichment produce lasting effects on infant affect?
...
A fully reproducible manuscript; data; analysis and visualization code; and other materials are available at https://github.com/themusiclab/musical-babies. This repository will be permanently archived on Zenodo at the time of publication. Analyses were exploratory and not preregistered.
