...
et al., 2013}), shaping language development and subsequent literacy
skills (\citeproc{ref-Cheng2023}{Cheng et al., 2023};
\citeproc{ref-Hemmerechts2017}{Hemmerechts et al., 2017}). Moreover,
...
(\citeproc{ref-Costa-Giomi2014}{Costa-Giomi \& Ilari, 2014};
\citeproc{ref-Nakata2004}{Nakata \& Trehub, 2004};
...
than infant-directed speech (\citeproc{ref-Cirelli2020}{Cirelli \&
Trehub, 2020}), and in an open-ended listening task, infants became
fussy after approximately twice as much time when hearing singing,
relative to speech (\citeproc{ref-Corbeil2016}{Corbeil et al., 2016}).
...
caregivers and their infants (\citeproc{ref-Fancourt2017}{Fancourt \&
Perkins, 2017}; \citeproc{ref-Steinberg2021}{Steinberg et al., 2021}).
...
settings (e.g., \citeproc{ref-Arnon2014}{Arnon et al., 2014};
...
2023}; \citeproc{ref-Liu2023}{Liu, Hilton, et al., 2023}), served as an
...
(\citeproc{ref-deBarbaro2023}{Barbaro et al., 2023};
...
spanning less than 2 weeks (e.g., \citeproc{ref-deBarbaro2023}{Barbaro
et al., 2023}; \citeproc{ref-Franchak2019}{Franchak, 2019};
...
(\citeproc{ref-Kuczynski2023}{Kuczynski et al., 2023};
